...
export function Btn({className, children, onClick}: BtnProps): ReactElement {
    return <button className={className} onClick={onClick}>{children}</button>
}

export function BtnPrimary({className, children, onClick}: BtnProps): ReactElement {
    return <Btn
...
export function BtnSecondary({className, children, onClick}: BtnProps): ReactElement {
    return <Btn
...
export function BtnDanger({className, children, onClick}: BtnProps): ReactElement {
    return <Btn
...
export function BtnTextPrimary({className, children, onClick}: BtnProps): ReactElement {
    return <Btn
