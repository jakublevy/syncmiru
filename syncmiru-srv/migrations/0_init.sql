...
ALTER TABLE "user" ADD FOREIGN KEY ("reg_tkn_id") REFERENCES "reg_tkn" ("id");
...
ALTER TABLE "perm_assignment" ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id");
...
ALTER TABLE "email_sent_log" ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id");
